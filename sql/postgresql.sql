...
BEGIN
	...
	INSERT INTO audit (status, site, location, contact, section, priority, contact_email, technician, notes, updater, ticket) values (status_val, site_val, location_val, author_val, contact_val, section_val, priority_val, contact_email_val, tech_val, notes_val, submitter_val, last_id);
